...
CREATE SEQUENCE IF NOT EXISTS "public"."item_categories_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE "public"."karma_events" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."karma_events"
    ADD CONSTRAINT "karma_events_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."karma_events"
    ADD CONSTRAINT "karma_events_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."items"("id");



ALTER TABLE ONLY "public"."karma_events"
    ADD CONSTRAINT "karma_events_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id");
...
ALTER TABLE ONLY "public"."tips"
    ADD CONSTRAINT "tips_item_id_fkey" FOREIGN KEY ("item_id") REFERENCES "public"."items"("id");
...
CREATE POLICY "Public can read all items" ON "public"."items" FOR SELECT USING (true);
...
CREATE POLICY "Users can insert their own karma event" ON "public"."karma_events" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can insert tips they send" ON "public"."tips" FOR INSERT WITH CHECK (("auth"."uid"() = "sender_id"));



CREATE POLICY "Users can read messages they're part of" ON "public"."messages" FOR SELECT USING ((("auth"."uid"() = "sender_id") OR ("auth"."uid"() = "receiver_id")));
...
CREATE POLICY "Users can view their own karma" ON "public"."karma_events" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view tips they are part of" ON "public"."tips" FOR SELECT USING ((("auth"."uid"() = "sender_id") OR ("auth"."uid"() = "receiver_id")));
...
GRANT ALL ON TABLE "public"."karma_events" TO "anon";
GRANT ALL ON TABLE "public"."karma_events" TO "authenticated";
GRANT ALL ON TABLE "public"."karma_events" TO "service_role";
